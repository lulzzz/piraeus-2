...
namespace SkunkLab.Channels
{
    public abstract class ChannelFactory
    {
        ...
        public static IChannel Create(bool usePrefixLength, TcpClient client, TlsPskIdentityManager pskManager, int blockSize, int maxBufferSize, CancellationToken token)
        {
